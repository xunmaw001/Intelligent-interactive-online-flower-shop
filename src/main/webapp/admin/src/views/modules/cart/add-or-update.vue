    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='xianhua' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xianhuaPhoto" label="鲜花照片" prop="xianhuaPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (xianhuaForm.xianhuaPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xianhuaPhoto" label="鲜花照片" prop="xianhuaPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.xianhuaPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花库存" prop="xianhuaKucunNumber">
                        <el-input v-model="xianhuaForm.xianhuaKucunNumber"
                                  placeholder="鲜花库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="鲜花库存" prop="xianhuaKucunNumber">
                            <el-input v-model="ruleForm.xianhuaKucunNumber"
                                      placeholder="鲜花库存" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="鲜花用途" prop="xianhuaYongtu">
                        <el-input v-model="xianhuaForm.xianhuaYongtu"
                                  placeholder="鲜花用途" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xianhua' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="xianhuaClicknum">
                        <el-input v-model="xianhuaForm.xianhuaClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="xianhuaClicknum">
