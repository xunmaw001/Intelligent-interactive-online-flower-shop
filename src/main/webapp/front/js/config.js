...
var centerMenu = [
    ...
    ,{
        name: '鲜花收藏',
        url: '../xianhuaCollection/list.html'
    }
    ,{
        name: '鲜花订单',
        url: '../xianhuaOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '鲜花',
        url: './pages/xianhua/list.html'
    },

]

var adminurl =  "http://localhost:8080/xianhuashangcheng/admin/dist/index.html#/login";
